...
<div class="hero">
    ...
    <div class="hero-btns">
        ...
        <a href="<?php echo e(route('login')); ?>" class="btn-hero-ghost">
            Sign In
        </a>
    </div>
</div>
...
<div class="cta">
    <div class="cta-box">
        ...
        <div style="display:flex;gap:12px;justify-content:center;flex-wrap:wrap">
            <a href="<?php echo e(route('register')); ?>" class="btn-hero-primary">Create Account →</a>
...
<footer class="footer">
    ...
    <div class="footer-copy">© <?php echo e(date('Y')); ?> MediCare Hospital Management System. All rights reserved.</div>
</footer>

</body>
</html><?php /**PATH C:\Laravel\hospital-system\resources\views/welcome.blade.php ENDPATH**/ ?>